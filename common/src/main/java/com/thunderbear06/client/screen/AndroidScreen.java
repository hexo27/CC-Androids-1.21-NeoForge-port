package com.thunderbear06.client.screen;
...
public class AndroidScreen extends AbstractComputerScreen<AndroidMenu> {
    private static final Identifier BACKGROUND_NORMAL = Identifier.of(CCAndroids.MOD_ID, "textures/gui/android_normal.png");
    private static final Identifier BACKGROUND_ADVANCED = Identifier.of(CCAndroids.MOD_ID, "textures/gui/android_advanced.png");
    private static final Identifier BACKGROUND_COMMAND = Identifier.of(CCAndroids.MOD_ID, "textures/gui/android_command.png");
    ...
    protected TerminalWidget createTerminal() {
        ...
        return new TerminalWidget(this.terminalData, this.computerInput, this.computerActions, this.x + 8 + 17, this.y + 6); //fallback terminal, which will crash in... 1.117.x...
    }
    ...
    protected void drawBackground(DrawContext graphics, float partialTicks, int mouseX, int mouseY) {
        ...
        graphics.drawGuiTexture(texture, this.x + 17, this.y, 278, 217);
        graphics.drawGuiTexture(computerTextures.sidebar(), this.x, this.y + this.sidebarYOffset, AbstractComputerMenu.SIDEBAR_WIDTH, ComputerSidebar.HEIGHT);
