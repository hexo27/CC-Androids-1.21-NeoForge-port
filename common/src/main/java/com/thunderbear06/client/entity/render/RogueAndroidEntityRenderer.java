...
public class RogueAndroidEntityRenderer extends BipedEntityRenderer<RogueDroidEntity, PlayerEntityModel<RogueDroidEntity>> {
    private final Identifier androidRogue = Identifier.of(CCAndroids.MOD_ID, "textures/entity/android_rogue.png");
    private final Identifier androidRogueE = Identifier.of(CCAndroids.MOD_ID, "textures/entity/emissive/android_rogue_e.png");
